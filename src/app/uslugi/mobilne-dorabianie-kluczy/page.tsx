...
const CATEGORY_SLUG = "mobilne-dorabianie-kluczy";
...
export async function generateMetadata(): Promise<Metadata> {
	...
	const title = category.meta_title || "Dorabianie kluczy z dojazdem do klienta — Kraków";
	const description =
		category.meta_description ||
		"Dorabianie kluczy mieszkaniowych i samochodowych z dojazdem do klienta w Krakowie i okolicy.";
...
export default async function MobileKeysPage() {
		...
		<div className="mb-10 w-full">
				...
				<div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-[1.2fr_1fr]">
					<div>
						<h1 className="mb-4 text-2xl font-bold leading-tight sm:text-3xl">
							{menuItems.h1_tag || "Dorabianie kluczy z dojazdem do klienta — Kraków i okolice"}
						</h1>
						<p className="mb-5 text-base leading-relaxed text-gray-700">
							Klucze mieszkaniowe, samochodowe i do skrzynek pocztowych dorabiamy na miejscu — u
							Ciebie w domu, biurze lub na parkingu. Bez wizyty w punkcie stacjonarnym w Rybnej.
							Dojazd na terenie Krakowa i okolic w ciągu {deliveryTimeHours}{" "}
							{deliveryTimeHours === 1 ? "godziny" : "godzin"} od zamówienia.
						</p>
					...
					<div className="rounded-lg bg-white p-6 shadow-sm">
						<div className="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-500">
							Minimalne zamówienie na dojazd
						</div>
						<div className="mb-1 text-2xl font-bold">od {minKeysQty} szt. kluczy</div>
						<p className="text-sm text-gray-600">
							Przy mniejszej liczbie doliczamy opłatę logistyczną — zapytaj przy zgłoszeniu.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="mt-8 rounded-lg border border-gray-200 p-6 sm:p-8">
				...
				<p className="mb-5 text-sm text-gray-600">
					...
					przed Twoim zamówieniem.
				</p>
				<KeyPhotoInquiry />
			</section>

			<MobileServiceContactBar
				title="Zamów dorobienie kluczy z dojazdem"
			...
			<section className="mt-8 rounded-lg bg-gray-100 p-6 sm:p-8">
				...
				<div className="mb-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
					<div className="rounded-lg bg-white p-5 shadow-sm">
						<div className="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-500">
							Minimum logistyczne na dojazd
						</div>
						<div className="text-xl font-bold">od {minKeysQty} szt. kluczy</div>
						<p className="mt-2 text-sm text-gray-600">Poniżej tej liczby doliczamy opłatę za dojazd.</p>
					</div>
					<div className="rounded-lg bg-white p-5 shadow-sm">
						<div className="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-500">
						...
						<p className="mt-2 text-sm text-gray-600">
							Dla firm i stałych klientów — indywidualny cennik na zapytanie.
						</p>
					</div>
				</div>
			...
			<MobileServiceAreaGrid
				title="Obszar działania — mobilne dorabianie kluczy w Krakowie i okolicy"
				description={
					menuItems.seo_text ||
