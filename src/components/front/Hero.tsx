...
export const HeroItem: React.FC<{ heroData: Hero }> = ({ heroData }) => {
	return (
		<div className="mt-2 flex h-[1000px] w-full flex-wrap rounded-md bg-gray-100 shadow-md md:h-[500px]">
			...
			<div className="m-auto flex h-[500px] w-1/2 items-center justify-center">
				{heroData.image && (
					<Image
