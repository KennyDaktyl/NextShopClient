...
const CategoryDetails = ({ category }: { category: CategoryDetailsProps }) => {
	return (
		<div className="mt-10 w-full md:mt-0">
			<div className="flex w-full flex-wrap items-center justify-center rounded-md bg-gray-100 shadow-md md:h-[400px]">
				...
				{category.image && (
					<div className="m-auto flex h-[400px] w-full items-center justify-center md:w-1/2">
						<Image
							...
							height={category.image.height || 340}
							width={category.image.width || 340}
						/>
					</div>
				)}
			</div>
